loadstring(game:HttpGet("https://raw.githubusercontent.com/quickfixlol/xeno/refs/heads/main/fix"))()
local repo = 'https://raw.githubusercontent.com/violin-suzutsuki/LinoriaLib/main/'
local Library = loadstring(game:HttpGet(repo .. 'Library.lua'))()
local ThemeManager = loadstring(game:HttpGet(repo .. 'addons/ThemeManager.lua'))()
local SaveManager = loadstring(game:HttpGet(repo .. 'addons/SaveManager.lua'))()
local Window = Library:CreateWindow({ Title = '                     $ x1s | private $                     ', AutoShow = true, TabPadding = 15, MenuFadeTime = 0.2 })
...
local WatermarkConnection = RunService.RenderStepped:Connect(function()
    ...
    Library:SetWatermark(("[ x1s ] | $ private $ |  %s | %s (%d) | Uptime: %s | FPS %d | %d ms"):format(
...
Frame.Size = UDim2.new(0, 300, 0, 70) -- Increased size to fit text
...
UsernameLabel.Text = "Welcome! Thank you for using our script " .. player.Name
UsernameLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
UsernameLabel.Font = Enum.Font.SourceSansBold
UsernameLabel.TextSize = 18
UsernameLabel.TextWrapped = true -- Enable text wrapping
UsernameLabel.Parent = Frame

-- Make UI disappear after 5 seconds
task.wait(5)
ScreenGui:Destroy()
